...
public class DBConn {
	...
	// local開発用JDBC_URLを定義
	private static final String LOCAL_JDBC_URL = "jdbc:h2:tcp://localhost:9092/t54-db";
	// 本番用JDBC_URLを定義
	private static final String PROD_JDBC_URL = "jdbc:h2:tcp://my-h2-service.default.svc.cluster.local:9092/t54-db";
