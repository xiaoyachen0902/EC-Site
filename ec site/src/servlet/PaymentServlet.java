...
public class PaymentServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(account != null) {
		    request.getRequestDispatcher("WEB-INF/payment.jsp?msg=logined").forward(request, response);;
			}
			else {
			    request.getRequestDispatcher("WEB-INF/payment.jsp?msg=notlogin").forward(request, response);
			} 
