...
<br><h4>届け先住所</h4>
郵便番号:<%=request.getAttribute("postno") %><br>
住所:<%=request.getAttribute("address")%><br>
電話番号:<%=request.getAttribute("phoneno")%> <br>
...
数量:${buyquantity}<br>
消費税：${taxprice}<br>
商品金額(税込)：${totalprice}円<br>
送料:${deliveryfee}円${alarm}<br>
総計金額:${allprice}円  <br>
...
<input class="btn btn-primary" type="submit" value="お支払い手続き"></form><br>
